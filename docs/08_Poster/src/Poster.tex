...
\usepackage[paperwidth=48in,paperheight=36in,
            left=1.5in,right=1.5in,top=1.5in,bottom=1.5in]{geometry}
...
by Fox Kang. An ESP32 reads a capacitive electrode; on a touch event
...
\centering
\includegraphics[height=7in]{./Pictures/Ladder_1.png}\hspace{6pt}%
\includegraphics[height=7in]{./Pictures/Ladder_2.png}\hspace{6pt}%
\includegraphics[height=7in]{./Pictures/Ladder_3.png}\hspace{6pt}%
\includegraphics[height=7in]{./Pictures/Ladder_4.png}\hspace{6pt}%
\includegraphics[height=7in]{./Pictures/Ladder_5.png}\hspace{6pt}%
\includegraphics[height=7in]{./Pictures/Ladder_6.png}\hspace{6pt}%
\includegraphics[height=7in]{./Pictures/Ladder_7.png}\\[2pt]
...
% Four equal-width info cards, one tcolorbox each, side by side.
\vspace{10pt}
\noindent
\newcommand{\statbox}[2]{%
  \begin{tcolorbox}[
