...
\begin{center}
\includegraphics[height=3in]{./Pictures/Panel_CAD_Layout.png}\\[2pt]
{\small\itshape Panel back-plate drawn in AutoCAD Electrical: terminal blocks, DirectLOGIC 205 rack, SD-N35 contactor, fused 24\,V branch, Huanyang VFD, EA1-T4CL HMI cut-out.}
\end{center}
