...
% PSU palette + EDGE-MODE additions (dark inverse theme)
...
\definecolor{edgeBG}{RGB}{12,14,18}        % near-black poster background
\definecolor{edgePanel}{RGB}{22,26,32}     % slightly lighter for cards
\definecolor{edgeNeon}{RGB}{198,255,32}    % hot acid-green accent
\definecolor{edgeCyan}{RGB}{0,230,255}     % electric cyan secondary
\definecolor{edgeText}{RGB}{235,238,242}   % off-white body text
\definecolor{edgeDim}{RGB}{170,178,190}    % dim gray for captions
...
% EDGE-MODE section header: dark slab with a hot neon-green left bar
\newcommand{\postersec}[1]{%
  \par\vspace{6pt}%
  \noindent
  \begin{tcolorbox}[
    enhanced, sharp corners, boxrule=0pt, frame hidden,
    interior style={fill=edgePanel},
    coltext=edgeNeon,
    borderline west={6pt}{0pt}{edgeNeon},
    left=16pt, right=14pt, top=8pt, bottom=8pt,
    width=\linewidth,
...
% EDGE-MODE stat cards: dark fill, hot neon top rule, neon title
\newtcolorbox{statcard}[1]{enhanced, sharp corners, boxrule=0pt, frame hidden,
  interior style={fill=edgePanel},
  borderline north={4pt}{0pt}{edgeNeon},
  left=12pt, right=12pt, top=8pt, bottom=10pt,
  fontupper=\sffamily\color{edgeText}, title=#1, coltitle=edgeNeon,
  fonttitle=\sffamily\bfseries\large,
  attach title to upper={\par\smallskip}}

\begin{document}

% EDGE-MODE: dark page background + off-white default text
\pagecolor{edgeBG}
\color{edgeText}
...
\begin{tcolorbox}[
  enhanced, sharp corners, boxrule=0pt, frame hidden,
  interior style={fill=edgePanel},
  borderline north={6pt}{0pt}{edgeNeon},
  borderline south={6pt}{0pt}{edgeCyan},
  coltext=edgeText,
...
\begin{minipage}[c]{0.72\linewidth}
  {\fontsize{90pt}{96pt}\selectfont\bfseries
   \color{edgeNeon}UNIVERSAL PLASTIC SHREDDER V2.0}\\[6pt]
  {\fontsize{40pt}{46pt}\selectfont\bfseries\color{edgeCyan} Electrical Control \& Power System}\\[14pt]
  {\fontsize{28pt}{32pt}\selectfont\color{edgeText}
   Bao Nguyen\;\textbullet\;Fearghus Tyler\;\textbullet\;Yaqoub Rabiah\;\textbullet\;Fox Kang}\\[6pt]
  {\fontsize{22pt}{26pt}\selectfont\color{edgeDim}
...
\begin{tcolorbox}[
  ...
  coltext=edgeNeon,
  borderline west={6pt}{0pt}{edgeNeon},
  borderline east={6pt}{0pt}{edgeCyan},
  left=16pt, right=14pt, top=8pt, bottom=8pt,
  width=\textwidth,
  fontupper=\sffamily\bfseries\large,
]
\textsc{Complete Ladder Logic} \;\textbullet\; 31 rungs \;\textbullet\; 7 pages
\end{tcolorbox}
\vspace{4pt}
\noindent
...
\newcommand{\statbox}[2]{%
  \begin{tcolorbox}[
    ...
    fontupper=\sffamily\normalsize\color{edgeText},
    title=#1, coltitle=edgeNeon,
    fonttitle=\sffamily\bfseries\large,
    attach title to upper={\par\smallskip},
  ]
  #2
