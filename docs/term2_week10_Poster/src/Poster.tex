...
{\small\itshape AutoCAD Electrical: front operator face (left) with power switch, HMI cut-out, status lights, fwd / rev / deadman pushbuttons, and E-stop; back-plate component layout (right) with terminal blocks, DirectLOGIC 205 rack, SD-N35 contactor, fused 24\,V branch, Huanyang VFD, and HMI cut-out.}
\end{center}
