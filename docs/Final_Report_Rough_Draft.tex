...
% Portland State accent color for the cover page
\definecolor{psugreen}{RGB}{16,79,56}
...
\noindent\colorbox{psugreen}{%
  \makebox[\textwidth][c]{\rule[-0.6em]{0pt}{2.2em}%
  \color{white}\Large\bfseries PORTLAND STATE UNIVERSITY}}

\vspace{4pt}
{\large Maseeh College of Engineering \& Computer Science}\\[2pt]
{\large Department of Electrical \& Computer Engineering}\\[6pt]
{\normalsize\itshape ECE 412/413 Senior Capstone Project \;\textbullet\; Winter--Spring 2026}

\vfill

{\color{psugreen}\Huge\bfseries Universal Plastic Shredder V2.0}\\[10pt]
{\LARGE Electrical Control \& Power System}\\[14pt]
{\large\itshape Final Report}

\vspace{20pt}
{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{1pt}%
 \fcolorbox{psugreen}{white}{\includegraphics[width=0.74\textwidth]{images/image.png}}}\\[6pt]
{\footnotesize\itshape Operator control panel layout}

\vfill

{\color{psugreen}\rule{\textwidth}{1.5pt}}
\vspace{8pt}

{\renewcommand{\arraystretch}{1.3}
\begin{tabular}{r@{\quad}l}
\textbf{Team 07} & \emph{I'm So Shredded, Inc.} \\
 & Bao Nguyen \;\textbullet\; Fearghus Tyler \;\textbullet\; Yaqoub Rabiah \;\textbullet\; Fox Kang \\[3pt]
\textbf{Industry Sponsor} & MME / Ichor Systems --- Bridget Lannigan \\
\textbf{Faculty Advisors} & Prof. Andrew Greenberg \;\textbullet\; Dr. Jonathan Bird (EE) \;\textbullet\; Robert Paxton (ME) \\
\end{tabular}}

\vspace{10pt}
\noindent\colorbox{psugreen}{%
  \makebox[\textwidth][c]{\rule[-0.5em]{0pt}{1.8em}%
  \color{white}\normalsize Portland, Oregon \;\textbullet\; May 31, 2026}}
