...
\begin{itemize}
    ...
    \item \textbf{HMI:} AutomationDirect C-more EA9-T6CL-R 6-inch color touch panel, connected to the H2-DM1E CPU serial communication port (operator commands to the PLC; status/data back to the panel). Powered from a separate Rhino PSB12-030-P DC supply.
