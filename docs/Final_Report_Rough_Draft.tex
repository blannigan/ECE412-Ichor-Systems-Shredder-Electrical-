...
\begin{itemize}
    ...
    \item \textbf{HMI:} AutomationDirect C-more EA9-T6CL-R 6-inch color touch panel, connected to the H2-DM1E CPU communication port (operator commands to the PLC; status/data back to the panel). Powered from a separate Rhino PSB12-030-P DC supply. \note{The Point List documents this as a serial COM-port link; the signal-flow bullet below still says Ethernet. The H2-DM1E supports both -- reconcile to the as-built before final.}
